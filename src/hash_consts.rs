/// The base CRC seed that FFXIV uses for its hashing
pub const FFXIV_SEED: u32 = 0xFFFFFFFF;

/// The CRC table that FFXIV uses for its hashing
pub const FFXIV_CRC_TABLE: [u32; 256] = [
